...
const Notification = () => {
    ...
    const {notifications, userChats, allUsers, markAllNotificationsAsRead, markNotificationAsRead} = useContext(ChatContex);
        ...
        {isOpen ? <div className="notifications-box">
            ...
            <div className="notification-content">
                ...
                {modifiedNotifications && modifiedNotifications.map((n, index) => {
                    return <div className={n.isRead ? "notification" : "notification not-read"} key={index} onClick={()=>{
